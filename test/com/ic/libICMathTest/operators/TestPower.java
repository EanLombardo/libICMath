...
public class TestPower
{
	...
	{
		assertEquals(calc.stringEvalExpression("239193.193948719782^4.293781632"),nts(ICMath.pow(239193.193948719782,4.293781632D)));
	}
	@Test
	public final void atonOfRandoms()
	{
		...
		for(int i=0;i<OperatorTests.randoms;i++)
		{
			...
			assertEquals(calc.stringEvalExpression(nts(one)+"^"+nts(two)),nts(ICMath.pow(new Double(nts(one)),new Double(nts(two)))));
		}
	}
