...
public class TestDelete
{
	...
	public final void x()
	{
		...
		assertTrue(calc.stringEvalExpression("delete(x)").equals(nts(1.0D)));
	...
	public final void dude()
	{
		...
		assertTrue(calc.stringEvalExpression("delete(dude)").equals(nts(1.0D)));
		assertTrue(calc.stringEvalExpression("dude").equals(nts(0.0D)));
	}
	@Test
	public final void doesntExist()
	{
		assertTrue(calc.stringEvalExpression("delete(dude)").equals(nts(0.0D)));
	}
	@Test
	public final void several()
	{
		...
		assertTrue(calc.stringEvalExpression("delete(x)").equals(nts(1.0D)));
		assertTrue(calc.stringEvalExpression("delete(dude)").equals(nts(1.0D)));
		assertTrue(calc.stringEvalExpression("delete(g)").equals(nts(1.0D)));
		assertTrue(calc.stringEvalExpression("x").equals(nts(0.0D)));
		assertTrue(calc.stringEvalExpression("dude").equals(nts(0.0D)));
