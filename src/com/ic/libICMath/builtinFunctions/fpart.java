...
public class fpart extends ICBuiltinFunction
{
	public fpart(ICCalculatorBase calc)
	{
		super(calc);
	}
	...
	public boolean eval(ICLinkedList output, ICLinkedList.Node position, String basis, double parentIn)
	{
		...
		{
			position.prev.data.number=ICMath.fpart(position.prev.data.number);
