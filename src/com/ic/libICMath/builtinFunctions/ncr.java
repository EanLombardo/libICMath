...
public class ncr extends ICBuiltinFunction
{
	public ncr(ICCalculatorBase calc)
	{
		super(calc);
	}
	...
	public boolean eval(ICLinkedList output, ICLinkedList.Node position, String basis, double parentIn)
	{
		...
		{
			position.prev.prev.data.number=ICMath.ncr(position.prev.prev.data.number,position.prev.data.number);
