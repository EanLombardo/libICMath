...
public class ipart extends ICBuiltinFunction
{
	public ipart(ICCalculatorBase calc)
	{
		super(calc);
	}
	...
	public boolean eval(ICLinkedList output, ICLinkedList.Node position, String basis, double parentIn)
	{
		...
		{
			position.prev.data.number=ICMath.ipart(position.prev.data.number);
